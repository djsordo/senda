...
export class JugadorIntentEs{
  ...
  constructor( private eventosService: EventosService,
    ...
    this.aliasAcciones = [  { accion: Acciones.parada, alias: ['parada', 'paradón'] },
                            ...
                            { accion: Acciones.dosMinutos, alias: ['dos minutos', '2 minutos'] },
                            { accion: Acciones.tarjetaAmarilla, alias: ['tarjeta amarilla', 'amarilla'] },
                            { accion: Acciones.tarjetaRoja, alias: ['tarjeta roja', 'roja'] },
                            { accion: Acciones.tarjetaAzul, alias: ['tarjeta azul', 'azul'] }
                          ];
  }
  ...
  public parseSentence( sentence: string ): Evento {
    const eventParsed = this.eventosService.newEvento();
